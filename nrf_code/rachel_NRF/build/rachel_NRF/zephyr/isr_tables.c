...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[39] = {
	{(const void *)0xafed, (ISR)0xaf41}, /* 0 */
	{(const void *)0x0, (ISR)z_irq_spurious}, /* 1 */
	{(const void *)0xbb34, (ISR)0xaebd}, /* 2 */
	{(const void *)0x20001150, (ISR)0x61ed}, /* 3 */
	{(const void *)0x20001aa8, (ISR)0x68dd}, /* 4 */
	{(const void *)0x0, (ISR)z_irq_spurious}, /* 5 */
	{(const void *)0x200010e0, (ISR)0xac51}, /* 6 */
